...
1. Créer un vecteur appelé "sample_age" avec une centaine d'âge tiré au sort entre 10 et 80 ans.
...
1. Exporter ce data frame en fichier *.csv* avec la fonction `write.csv()`.
